...
cp $CMSSW_BASE/src/test/SMP-RunIISummer16MiniAODv3-00212.root /eos/user/s/sdeng/WZG_analysis/$DATE 
cp $CMSSW_BASE/src/test/SMP-RunIISummer16MiniAODv3-00212.root .
rm $sandbox_name
