...
def prepare_crab(name,sample_type,year):
    ...
    with open('crabcode_' + year + '/' + abbre_name + '_cfg.py', 'w+') as f:
        ...
        f.write('config.JobType.inputFiles = ["../../scripts/haddnano.py","./HLT_template_postproc.py","./HLT_template_Module.py","./WZG_input_branch.txt","./WZG_output_branch.txt","../WZG_selector/DAS_filesearch.py"] #hadd nano will not be needed once nano tools are in cmssw \n')
