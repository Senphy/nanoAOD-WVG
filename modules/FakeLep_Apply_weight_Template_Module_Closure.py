...
class ApplyWeightFakeLeptonProducer(Module):
    ...
    def beginJob(self):
        if self.year == '2018':
            self.file_ele = ROOT.TFile("%s/src/PhysicsTools/NanoAODTools/nanoAOD-WVG/plot/Fake_Lepton/Ele_Fake_Rate_2D_2018_Closure.root" % os.environ['CMSSW_BASE'],"READ")
            self.file_mu = ROOT.TFile("%s/src/PhysicsTools/NanoAODTools/nanoAOD-WVG/plot/Fake_Lepton/Mu_Fake_Rate_2D_2018_Closure.root" % os.environ['CMSSW_BASE'],"READ") 
        elif self.year == '2017':
            self.file_ele = ROOT.TFile("%s/src/PhysicsTools/NanoAODTools/nanoAOD-WVG/plot/Fake_Lepton/Ele_Fake_Rate_2D_2017_Closure.root" % os.environ['CMSSW_BASE'],"READ")
            self.file_mu = ROOT.TFile("%s/src/PhysicsTools/NanoAODTools/nanoAOD-WVG/plot/Fake_Lepton/Mu_Fake_Rate_2D_2017_Closure.root" % os.environ['CMSSW_BASE'],"READ") 
