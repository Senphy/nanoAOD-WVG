...
def prepare_crab(name,sample_type,year,period):
    ...
    with open('AR_crabcode_' + year + '/' + abbre_name + '_cfg.py', 'w+') as f:
        ...
        f.write('config.JobType.inputFiles = ["../../scripts/haddnano.py","./AR_Template_postproc.py","./AR_keep_and_drop.txt","./AR_output_branch_selection.txt"] #hadd nano will not be needed once nano tools are in cmssw \n')
